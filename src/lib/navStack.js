...
const PG_LABELS = {
  ...
  visa_wakalah_grid: { ar: 'جدول الوكالات', en: 'PoA Grid' },
  iqama_grid: { ar: 'جدول إصدار الإقامات', en: 'Iqama Issuance Grid' },
  iqama_delivery_grid: { ar: 'جدول توصيل الإقامات', en: 'Iqama Delivery Grid' },
