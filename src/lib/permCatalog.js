...
const OPS_SHEETS = [
  ...
  ['iqama_expiring', 'العمالة — قاربت الانتهاء', 'العمالة', true],
  ['recoveries', 'الاسترجاعات', 'المالية'],
  ...
  ['worker_overdue', 'متأخّرات العمالة', 'المالية', true],
