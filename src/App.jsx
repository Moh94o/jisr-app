...
<svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="rgba(176,125,0,.72)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{flexShrink:0,transition:'stroke .18s'}}><circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3a14 14 0 010 18 14 14 0 010-18z"/></svg>
</div>
