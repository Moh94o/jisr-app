...
const goldS={width:'100%',height:48,background:'linear-gradient(160deg,#23201a,#141210)',border:'1px solid rgba(176,125,0,.5)',borderRadius:12,fontFamily:F,fontSize:16,fontWeight:600,color:'#F0CB6A',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',gap:10,boxShadow:'0 6px 18px rgba(0,0,0,.28), inset 0 1px 0 rgba(176,125,0,.18)',transition:'.2s'}
