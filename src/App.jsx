...
{/* ═══ TOPBAR ═══ */}
<header className='dash-header' style={{minHeight:56,paddingTop:'max(0px, env(safe-area-inset-top))',paddingLeft:'max(20px, env(safe-area-inset-left))',paddingRight:'max(20px, env(safe-area-inset-right))',background:'var(--sb)',display:'flex',alignItems:'center',gap:14,flexShrink:0,boxShadow:'0 2px 12px rgba(0,0,0,.12)',minWidth:0}}>
