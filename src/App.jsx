...
{n.icon}<span style={{fontSize:10,fontWeight:pg===n.id?600:500,color:pg===n.id?C.gold:sideOpen&&n.id==='_more'?C.gold:'var(--sbtx2)',transition:'color .15s ease'}}>{n.l}</span>
</div>)}</nav>
{/* ═══ INSTALL BANNER ═══ */}
