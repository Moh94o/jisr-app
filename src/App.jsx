...
<div className='topbar-ini' style={{display:'none',width:26,height:26,borderRadius:'50%',alignItems:'center',justifyContent:'center',background:'var(--accent-soft)',border:'1px solid var(--accent-bd)',color:C.gold,fontSize:13,fontWeight:700,flexShrink:0}}>{initial}</div>
</div>;
})()}
