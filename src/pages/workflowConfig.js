...
export const SERVICE_LABELS = {
  ...
  work_visa_9m:        { ar: 'تأشيرة بإقامة 9 أشهر',         en: '9-Month Visa & Iqama' },
...
export const PIPELINES = {
  ...
  work_visa_9m:        ['intake_invoice', 'visa_issuance', 'wakalah', 'medical_exam', 'work_permit', 'medical_insurance', 'iqama_issuance', 'iqama_delivery', 'review_close'],
